...
Public Class CybosBridge
    ...
    Public Sub Start()
        ...
        MessageBus.I.On(Topics.CANDLE_REQUEST, Sub(m)
                                                   Dim code = m.Str("code")
                                                   Dim tf = m.Str("timeframe", "m1").ToLower()
                                                   Dim count = m.Int("count", 2000)
                                                   ...
                                                   Select Case True
                                                       ...
                                                       Case tf.StartsWith("t")
                                                           _client.틱차트(code, count, Sub(r) EmitCandle(r, code))
        ...
        MessageBus.I.On(Topics.STOCK_BASIC_REQUEST, Sub(m) _client.종목기본정보(m.Str("code"), Sub(r)
                                                                                             ...
                                                                                             MessageBus.I.EmitOnUI(r)
                                                                                         End Sub))
        MessageBus.I.On(Topics.STOCK_MULTI_INFO_REQUEST, Sub(m) _client.복수종목정보(m.Str("codes"), Sub(r)
